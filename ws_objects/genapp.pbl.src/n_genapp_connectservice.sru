...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "D:\$$HEX2$$344ef665$$ENDHEX$$\2020-08-05\git\createnew_Hex\genapp.ini"
		...
		as_server		= ProfileString ( ls_inifile, "Database", "Servername", "172.16.1.102")
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "Database='intellisoft161'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "Servername", 	RegString!, as_server ) <> 1 Then
			RegistrySet ( ls_registrykey, "Servername", 	RegString!, "172.16.1.102" )
			RegistryGet ( ls_registrykey, "Servername", 	RegString!, as_server )
		End If
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "Database='intellisoft161'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logid			= "dba"
		as_logpass		= "sql"
		as_server		= "172.16.1.102"
		as_dbparm		= "Database='intellisoft161'"
		as_lock			= ""
		as_autocommit	= "false"
